...
export default function PrivacyPolicy() {
  return (
    <Section className="text-foreground gap-y-lg items-center bg-background flex-1 min-h-screen-minus-navbar">
      <div className="flex flex-col max-w-[800px] gap-y-lg">
        <Brief className="text-accent">Privacy Policy</Brief>
        ...
        <div className="flex flex-col gap-y-md">
          <h2 className="text-accent text-md">
            Interpretation and Definitions
          </h2>
          <div className="flex flex-col gap-y-xs">
            <h3 className="text-md text-foreground">Interpretation</h3>
            <p>
          ...
          <div className="flex flex-col gap-y-xs">
            <h3 className="text-md text-foreground">Definitions</h3>
            ...
            <ul className="flex flex-col gap-y-xs">
              ...
              <li>
                <p>
                  <strong>Country</strong> refers to: Western Australia,
                  Australia
                </p>
              </li>
              <li>
        ...
        <div className="flex flex-col gap-y-md">
          ...
          <div className="flex flex-col gap-y-xs">
            <h3 className="text-md text-foreground">Types of Data Collected</h3>
            <div className="flex flex-col gap-y-xs">
            ...
            <ul className="flex flex-col gap-y-xs mt-sm">
              <li>
                <p>Email address</p>
              </li>
              <li>
          ...
          <div className="flex flex-col gap-y-xs">
            ...
            <div className="flex flex-col gap-y-xs">
              <h4 className="font-semibold text-foreground">Law enforcement</h4>
              <p>
        ...
        <div className="flex flex-col gap-y-xs">
          <h2 className="text-accent text-md">Children&apos;s Privacy</h2>
          <p>
        ...
        <div className="flex flex-col gap-y-xs">
          <h2 className="text-accent text-md">Links to Other Websites</h2>
          <p>
        ...
        <div className="flex flex-col gap-y-xs">
          <h2 className="text-accent text-md">Contact Us</h2>
          <p>
